...
function awd_save_meta_box($post_id) {
...
function add_social_media() {
    $aanspreking = get_option('social_media_option_aanspreking');
    
    $facebookURL = get_option('social_media_option_facebookURL');
    $twitterURL = get_option('social_media_option_twitterURL');
    $googleplusURL = get_option('social_media_option_googleplusURL');
    $linkedinURL = get_option('social_media_option_linkedinURL');
    
    $facebookIcon = plugins_url('icons/'.get_option('social_media_option_icon_vorm').'/facebook.png', __FILE__);
    $twitterIcon = plugins_url('icons/'.get_option('social_media_option_icon_vorm').'/twitter.png', __FILE__);
    $googleplusIcon = plugins_url('icons/'.get_option('social_media_option_icon_vorm').'/googleplus.png', __FILE__);
    $linkedinIcon = plugins_url('icons/'.get_option('social_media_option_icon_vorm').'/linkedin.png', __FILE__);
    ?>
        <div>
            <p><?php echo $aanspreking ?></p>
            <a href="<?php echo $facebookURL; ?>"><img src="<?php echo $facebookIcon ?>" alt="facebook"></a>
            <a href="<?php echo $twitterURL; ?>"><img src="<?php echo $twitterIcon ?>" alt="facebook"></a>
            <a href="<?php echo $googleplusURL; ?>"><img src="<?php echo $googleplusIcon ?>" alt="facebook"></a>
            <a href="<?php echo $linkedinURL; ?>"><img src="<?php echo $linkedinIcon ?>" alt="facebook"></a>
        </div>
